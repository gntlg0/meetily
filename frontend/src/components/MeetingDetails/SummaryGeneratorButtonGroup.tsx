...
export function SummaryGeneratorButtonGroup({
  ...
  // API-only build: all summary providers are cloud APIs, so there is no
  // local model readiness to verify — generation proceeds directly and any
  // API/key errors surface from the generation call itself.
  const checkModelsAndGenerate = async () => {
